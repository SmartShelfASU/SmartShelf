          ...
          <form method="post" action="../products/add_product.php" class="clearfix">
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="product-title" value="" placeholder="Manufacturer P-N">
               </div>
              </div>
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="product-sku" value="" placeholder="Name">
               </div>
              </div>
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="number" class="form-control" name="product-location" value="" placeholder="Location">
               </div>
              </div>
