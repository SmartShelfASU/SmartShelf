         ...
         <div class="col-md-12">
           <form method="post" action="../products/edit_product.php?id=<?php echo (int)$product['id'] ?>">
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="product-title" value="<?php echo remove_junk($product['name']);?>" placeholder="Manufacturer P-N">
               </div>
              </div>
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="product-sku" value="<?php echo remove_junk($product['sku']);?>" placeholder="Name">
               </div>
              </div>
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="number" class="form-control" name="product-location" value="<?php echo remove_junk($product['location']);?>" placeholder="Location">
               </div>
              </div>
	      ...
	      <div class="form-group">
               <div class="row">
                 ...
                 <div class="col-md-4">
                  <div class="form-group">
                    <label for="cost-price">Weight (grams)</label>
                    <div class="input-group">
                      <span class="input-group-addon">
                  ...
                  <div class="col-md-4">
                   <div class="form-group">
                     ...
                     <div class="input-group">
                       ...
                       <input type="text" min="0" step="any" class="form-control" name="sale-price" value="<?php echo remove_junk($product['sale_price']);?>">
                    </div>
                   </div>
                  </div>
               </div>
