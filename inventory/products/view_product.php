...
if (isset($_POST['turn_off_led'])) {
    $command = escapeshellcmd('sudo python turnoff.py');
    shell_exec($command);
}
if (isset($_POST['turn_on_led'])) {
    	$product_location = $product['location'];
	$shell_command = "echo p1r4sp | sudo -S python testcom.py $product_location";
	$send_to_python =shell_exec($shell_command);
}
...
<div class="text-center">
    <form action="" method="POST">
        <button type="submit" name="turn_off_led" class="btn btn-danger">Turn off LED</button>
    </form>
</div>
...
<div class="text-center">
    <form action="" method="POST">
        <button type="submit" name="turn_on_led" class="btn btn-danger">Turn on LED</button>
    </form>
</div>
...
<!--     *************************     -->
                ...
                <th class="text-center" style="width: 15%;"> Weight (grams) </th>
